...
{
    [32928] = {cp =   250, lvl =  1, item =  4182},             -- scroll_of_instant_reraise
    [32929] = {cp =   200, lvl =  1, item =  4181},             -- scroll_of_instant_warp
...
local overseerInvNation =
{
    [0] = -- San d'Oria
    {
        ...
        [32787] = {rank =  2, cp =  2000, lvl = 20, item = 17367, place = 1},     -- royal_spearmans_horn
...
tpz.conquest.overseerOnEventUpdate = function(player, csid, option, guardNation)
    ...
    if stock ~= nil then
        ...
        if stock.item == 4181 then
            player:PrintToPlayer("NOTICE: WotG era cost for the Scroll of Instant Warp is 250 CP.",29)
        elseif stock.item == 4182 then
            player:PrintToPlayer("NOTICE: WotG era cost for the Scroll of Instant Reraise is 200 CP.",29)
        end
