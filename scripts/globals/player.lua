...
local function CharCreate(player)
    ...
    player:addItem(13180)-- bastok medal
    player:addItem(13179) -- sand collar
    player:addItem(13181) -- windy scarf
    player:addItem(15793) -- anni ring
    player:addSpell(307)  -- cait sith
    ...
    player:addLinkpearl("GoldenChocoboz", true)
