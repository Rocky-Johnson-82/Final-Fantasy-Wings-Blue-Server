...
MINING_BREAK_CHANCE     = 30 -- % chance for the pickaxe to break during mining.  Set between 0 and 100.
HARVESTING_RATE         = 55 -- % chance to recieve an item from haresting.  Set between 0 and 100.
EXCAVATION_RATE         = 55 -- % chance to recieve an item from excavation.  Set between 0 and 100.
LOGGING_RATE            = 55 -- % chance to recieve an item from logging.  Set between 0 and 100.
...
COFFER_MAX_ILLUSION_TIME = 2100  -- 35m
COFFER_MIN_ILLUSION_TIME = 1500  -- 25m
CHEST_MAX_ILLUSION_TIME  = 2100  -- 35m
CHEST_MIN_ILLUSION_TIME  = 1500  -- 25m
...
-- ADVENTURING FELLOWS
AdventuringFellow_Enabled = 1 -- Enables/Disables Adventuring Fellow acquisition quests and Adventuring Fellow Calling