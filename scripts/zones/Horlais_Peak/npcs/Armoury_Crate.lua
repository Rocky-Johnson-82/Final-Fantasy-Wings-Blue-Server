...
local loot =
{
    ...
    [1] =
    {
        ...
        },
        {
            ...
            {itemid = 13238, droprate = 200}, -- Druid's Rope
        ...
        },
        {
            ...
            {itemid = 4874, droprate = 123}, -- Scroll of Absorb-STR
        ...
        },
        {
            ...
            {itemid = 4874, droprate = 104}, -- Scroll of Absorb-STR
            {itemid = 788,  droprate =  94}, -- Peridot
            {itemid = 792,  droprate =  94}, -- Pearl
    ...
    [10] =
    {
        ...
        {
            {itemid = 12486, droprate = 150}, -- hairpin
            {itemid =     0, droprate =  850}, -- nothing (50%)
        },
        {
    ...
    -- KSNM Horns of War - Based on latest update to wiki
    [11] =
    {
        {
  ...
  --          {itemid = 17108, droprate = 53},  -- Healing Staff Removed as RMT Item
        },
        {
    ...
    [12] =
    {
        {
            {itemid = 0,     droprate = 900}, -- Nothing
            {itemid = 13056, droprate = 100},    -- peacock charm
        },
        {
