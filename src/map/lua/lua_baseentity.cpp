...
inline int32 CLuaBaseEntity::setSkillLevel(lua_State *L)
{
	...
	if (SkillID == 59)
	{
		double CurrentSkill = round(PChar->RealSkills.skill[SkillID]) / 10.0f;
		int precisionVal = 1;
		std::string CurrentSkillPacket;
		CurrentSkillPacket = "Your Chocobo Digging skill increases by .1 raising it to "; CurrentSkillPacket += std::to_string(CurrentSkill).substr(0, std::to_string(CurrentSkill).find(".") + precisionVal + 1); CurrentSkillPacket += "!";
		PChar->pushPacket(new CChatMessagePacket(PChar,MESSAGE_SYSTEM_3, CurrentSkillPacket, ""));
...
inline int32 CLuaBaseEntity::setSkillRank(lua_State *L)
{
	...
	if (skillID == 59)
	{
		...
		switch (newrank)
		{
			case 1: DingRank = "Recruit"; 		break;
			case 2: DingRank = "Initiate"; 		break;
			case 3: DingRank = "Novice"; 		break;
			case 4: DingRank = "Apprentice";	break;
			case 5: DingRank = "Journeyman";	break;
			case 6: DingRank = "Craftsman";		break;
			case 7: DingRank = "Artisan";		break;
			case 8: DingRank = "Adept";			break;
			case 9: DingRank = "Veteran";		break;
			case 10: DingRank = "Expert";		break;
		}
		std::string DingRankPacket;
		DingRankPacket = "You have been promoted to the "; DingRankPacket += DingRank; DingRankPacket += " Chocobo Digging Rank!";
		PChar->pushPacket(new CChatMessagePacket(PChar,MESSAGE_SYSTEM_3, DingRankPacket, ""));
	}
	else
	{
	PChar->pushPacket(new CCharSkillsPacket(PChar));	
...
inline int32 CLuaBaseEntity::addPartyEffect(lua_State *L)
{
    ...
    PEntity->ForParty([&](CBattleEntity* PMember)
    {
        ...
        {
            PMember->StatusEffectContainer->AddStatusEffect(new CStatusEffect(
